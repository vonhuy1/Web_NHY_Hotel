				...
				<div class="maghny-grid">
					<figure class="effect-lily">
						...
						<figcaption class="w3set-hny">
							<div>
								<h4 class="top-text">
									NHY Hotel and Best Resort <span>Peaceful Place to stay</span>
								</h4>
								<p>From 20$</p>
							</div>
						</figcaption>
					...
					<div class="room-info">
						<h3 class="room-title">
							<a href="room-single.html">NHY Hotel</a>
						</h3>
						<ul class="mb-3">
						...
						<p>VIP rooms at NHY Hotel with spacious space, you can freely choose</p>
