	...
	<div class="container py-sm-4">
		<div class="row">
			<div class="col-lg-6 singleblock1-left align-self">
				<h3 class="title-big">
					Natural relaxation  <br>SPA & Wellness
				</h3>
				<h5>Posted on December 11, 2022</h5>
			</div>
			...
			<div class="blog-posthny-info">
				<div class="single-post-image mb-4">
					<div class="post-content">
						<h3 class="title-small mb-2">Lorem ipsum dolor sit amet,
							consectetuer adipiscing elit.</h3>
					</div>
				</div>

				<div class="single-post-content">
					<p class="mb-4">Lorem ipsum dolor sit amet,Ea consequuntur
						illum facere aperiam sequi optio consectetur.Ea consequuntur illum
						...
						consectetur adipisicing elit. At, corrupti odit? At iure facere,
						porro repellat officia quas, dolores magnam assumenda soluta odit
						harum voluptate inventore ipsa maiores fugiat accusamus eos nulla.
						Iure voluptatibus explicabo officia.</p>
					<p class="mb-4">Lorem ipsum, dolor sit amet consectetur
						adipisicing elit. At, corrupti odit? At iure facere, porro
						repellat officia quas, dolores magnam assumenda soluta odit harum
						voluptate inventore ipsa maiores fugiat accusamus eos nulla. Iure
						voluptatibus explicabo officia.</p>
					<blockquote class="blockquote my-5">
						<div class="icon-quote">
							<span class="fa fa-quote-left" aria-hidden="true"></span>
						</div>
						Lorem ipsum dolor sit amet,Ea consequuntur illum facere aperiam
						sequi optio consectetur.Ea consequuntur illum facere aperiam sequi
						optio consectetur adipisicing elitFuga, suscipit totam animi
						consequatur.
						<footer class="blockquote-footer mt-3"> Alexander tony</footer>
					</blockquote>
					<p class="mb-4">Excepteur sint occaecat non proident, sunt in
						culpa quis. Phasellus lacinia id erat eu ullamcorper. Nunc id
						ipsum fringilla, gravida felis vitae. Phasellus lacinia id, sunt
						in culpa quis. .</p>
				...
				<p class="mt-4">
					Vivamus a ligula quam. Ut blandit eu leo non suscipit. <a href="#"
						class="use-admin">Anna Delpan</a> In interdum ullamcorper dolor eu
					mattis.Nulla quis lorem neque,Nulla quis lorem neque, mattis
					venenatis lectus.<a href="#" class="use-admin"> Delpan Deo</a> In
					interdum ullamcorper dolor eu mattis.Nulla quis lorem neque, mattis
					venenatis lectus. Duis feugiat tortor sed.Nulla quis lorem neque,
					mattis venenatis lectus. In interdum ullamcorper dolor eu
					mattis.Nulla quis lorem neque
				</p>
				...
				<nav class="post-navigation row mt-5">
					<div class="post-prev col-md-6">
						<span class="nav-title"> Prev Post </span> <a href="#url"
							rel="prev">
							<h5>Lorem ipsum dolor sit amet</h5>
						</a>
					</div>
					<div class="post-next col-md-6 text-md-right mt-md-0 mt-4">
						<span class="nav-title"> Next Post </span> <a href="#url"
							rel="next">
							<h5>Lorem ipsum dolor sit amet</h5>
						</a>
					</div>
