...
<%@ taglib prefix="mt" uri="http://NHYHotel.com"%>
		...
		<div class="container">
			<a class="navbar-brand"
			   href="${pageContext.request.contextPath }/home"> <img
					...
					alt="Your logo" style="height: 35px;" /> NHY HOTEL
			</a>
			...
			<div class="row footer-top-29">
				<div class="col-lg-3 col-md-6 col-sm-8 footer-list-29 footer-1">
					...
					<ul>
						<li>
							<p>
								<span class="fa fa-map-marker"></span> 01 Vo Van Ngan, Linh
								Chieu Ward, Thu Duc City, Ho Chi Minh City.
							</p>
						</li>
						<li><a href="tel:+7-800-999-800"><span
								class="fa fa-phone"></span> +84 123 456 789</a></li>
						<li><a href="mailto:nhyhotel@gmail.com" class="mail"><span
								class="fa fa-envelope-open-o"></span> nhyhotel@gmail.com</a></li>
					</ul>
				</div>
				<div
				...
				<div
					...
					<div class="footer-post mb-4">
						...
						<p class="small">
							<span class="fa fa-clock-o"></span> December 7, 2022
						</p>
					</div>
				...
				<div
					...
					<div class="footer-post mb-4">
						<p class="small">Bank <strong>BIDV</strong> HCMC Branch</p>
						<p class="small">Holder: NGUYEN THI DIEU HIEN</p>
						<p class="small">Account Number: 9704 1910 1381 5136</p>
					</div>
					<div class="footer-post">
						<p class="small">Bank <strong>BIDV</strong> HCMC Branch</p>
						<p class="small">Holder: HUYNH NGUYEN NHU NGUYEN</p>
						<p class="small">Account Number: 9704 001 088 696</p>
					</div>
				</div>
			</div>
		</div>
